...
import 'package:drivers/screens/detail_route_saving/detail_route_saving_screen.dart';
...
class RouteCustom {
  static final getPage = [
    ...
    GetPage(
        name: RouteName.detailRouteSaving,
        page: () => const DetailRouteSaving()),
  ];
}
