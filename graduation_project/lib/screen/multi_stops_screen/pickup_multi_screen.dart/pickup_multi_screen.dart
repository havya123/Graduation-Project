...
class PickupMultiScreen extends StatelessWidget {
  const PickupMultiScreen({super.key});
                        ...
                        child: ButtonWidget(
                          ...
                          function: () {
                            if (controller.pickPlace.value != null &&
                              ...
                              Get.toNamed(RouteName.selectMultiDestination);
                              return;
                            }
                            MyDialogs.error(
                                msg: "Please select area in Ho Chi Minh City");
                            return;
                          },
                          textButton: "Confirm Pick Place",
                          fontSize: 16,
                        ),
                      ),
                    ),
